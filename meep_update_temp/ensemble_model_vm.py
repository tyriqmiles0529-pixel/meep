...
class EnsemblePredictor:
    ...
    def save_models(self, suffix=''):
        ...
        joblib.dump(self.baselines.ridge, os.path.join(self.model_dir, f'ridge_model{suffix}.pkl'))
        print("Models saved.")
    ...
    def load_models(self, suffix=''):
        ...
        try:
            ...
            self.baselines.ridge = joblib.load(os.path.join(self.model_dir, f'ridge_model{suffix}.pkl'))
