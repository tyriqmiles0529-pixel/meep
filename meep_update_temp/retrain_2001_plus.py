#!/usr/bin/env python
"""
Retrain 2001-2021 Windows with Rolling Features

Deletes old windows and retrains with:
- Rolling features (L5, L10, L20 averages, trends, variance)
- TabNet embeddings
- All feature interactions
- Parallel training on Modal

Run: modal run retrain_2001_plus.py
"""

import modal

app = modal.App("retrain-2001-plus")
...
def delete_old_windows():
    """Delete old 2001-2021 windows from Modal volume"""
    from pathlib import Path

    print("="*70)
    print("DELETING OLD 2001-2026 WINDOWS FROM MODAL")
    print("="*70)
...
def main():
    """Retrain all 2001-2026 windows in parallel"""

    print("="*70)
    print("RETRAINING 2001-2026 WINDOWS WITH ROLLING FEATURES")
    print("="*70)
    print("\nThis will:")
    print("  1. Delete old 2001-2026 windows from Modal")
    print("  2. Retrain 9 windows in parallel with:")
    ...
    print("\n[*] Step 2: Training 9 windows in parallel...")
    ...
    print("  2. Update riq_analyzer.py to use new features")
    print("  3. Run backtest: modal run modal_backtest.py")
