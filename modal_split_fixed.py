#!/usr/bin/env python
"""
Modal Split Training - Fixed Entry Point

Uses the exact pattern from your working modal_train_all_cpu.py
"""

import modal

app = modal.App("nba-split-training-fixed")
...
def train_all_missing():
    """Train all missing windows sequentially"""
    # Get missing windows
