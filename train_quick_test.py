    ...
    with torch.no_grad():
        ...
        if hasattr(tabnet.network, 'tabnet'):
            ...
            if steps_output.ndim == 3:
                ...
                print("   ✅ Extracted 3D tensor → 2D embeddings")
            elif steps_output.ndim == 2:
                embeddings = steps_output.cpu().numpy()
                print("   ✅ Extracted 2D embeddings directly")
            else:
            ...
            if embeddings.shape[1] == 24:
                print("   ✅ SUCCESS: Got 24-dimensional embeddings!")
            elif embeddings.shape[1] == 1:
                print("   ⚠️  WARNING: Only 1-dimensional (predictions, not embeddings)")
            else:
                print(f"   ⚠️  Unexpected: {embeddings.shape[1]} dimensions")

        else:
            print("   ❌ Cannot find tabnet encoder in network")
            embeddings = None
...
if embeddings is not None:
    ...
    print("   ✅ Model saved to ./test_models/test_hybrid.pkl")
    ...
    print(f"   ✅ Model loaded and prediction works")
...
if embeddings is not None and embeddings.shape[1] == 24:
    ...
    print("   1. TabNet training: ✅")
    print("   2. Embedding extraction: ✅ (24 dimensions)")
    print("   3. Hybrid features: ✅")
    print("   4. LightGBM training: ✅")
    print("   5. Model save/load: ✅")
    ...
    print("   1. TabNet training: ✅")
    print("   2. Embedding extraction: ⚠️  (only 1D, not 24D)")
    print("   3. Hybrid features: ✅")
    print("   4. LightGBM training: ✅")
    print("   5. Model save/load: ✅")
